...
add_bg_from_local('C:/Users/alant/Documents/ML2 Project/mov_bg3.jpg')  



st.markdown(f'<h1 style="color:#212121;background-color: rgba(255, 255, 255, 0.3);font-size:48px;border-radius:3%;">{"Movie Recommendation System"}</h1>', unsafe_allow_html=True)
